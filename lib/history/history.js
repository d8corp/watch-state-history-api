...
var History = /** @class */ (function () {
    function History(locales, key) {
        ...
        if (key === void 0) { key = 'history-api ' + _package.version; }
            ...
            if (locales && locale !== currentLocale && (!locale || new RegExp("^(" + locales + ")$").test(locale))) {
                ...
                this.changeState(function (newUrl) {
                    window.history.pushState({
                        key: _this.key,
                        steps: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(steps_1)), [{
                                url: url_1,
                                position: position_1
                            }])
                    }, null, newUrl);
    ...
    Object.defineProperty(History.prototype, "search", {
        get: function () {
            var math = this.url.match(/^[^#?]*\?([^#]+)/);
            return math ? math[1] : '';
        },
    ...
    History.prototype.getSearch = function (key) {
    ...
    History.prototype.back = function (is, def, scrollFirst) {
        ...
        if (is) {
            ...
            var steps = this.state.steps;
            scroll__default['default'](steps[steps.length - 1].position, function () { return window.history.back(); });
        }
        else {
            window.history.back();
        }
    ...
    History.prototype.push = function (url, position, scrollFirst) {
        ...
        this.changeState(function (newUrl) {
            if (currentUrl !== url) {
                window.history.pushState({
                    key: _this.key,
                    steps: tslib.__spreadArray(tslib.__spreadArray([], tslib.__read(steps)), [{
                            url: currentUrl,
                            position: top
                        }])
                }, null, newUrl);
    ...
    History.prototype.is = function (reg) {
        ...
        if (!this.isCache[reg]) {
            ...
            this.isCache[reg] = new watchState.Cache(function () { return regExp_1.test(_this.url); }, true);
        }
    ...
    History.prototype.get = function (reg, index, defaultValue) {
        ...
        if (!this.getCache[index][reg]) {
            ...
            this.getCache[index][reg] = new watchState.Cache(function () {
    ...
    History.prototype.changeState = function (callback, locale, url, position, scrollFirst) {
        ...
        if (scrollFirst) {
            scroll__default['default'](position, mainCallback);
        }
        else {
            mainCallback();
            scroll__default['default'](position);
        }
    };
    tslib.__decorate([
        decorators.state
